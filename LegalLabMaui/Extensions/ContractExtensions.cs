...
using Label = Waher.Networking.XMPP.Contracts.HumanReadable.Label;

namespace LegalLabMaui.Extensions
{
	/// <summary>
	...
	public static class ContractExtensions
	{
		...
		/// <summary>
		/// Converts a <see cref="ProtectionLevel"/> enumeration to a MAUI color.
		/// </summary>
		public static Color? DefaultColor(this ProtectionLevel Protection)
		{
			return Protection switch
			{
				ProtectionLevel.Transient => Colors.LightBlue,
				ProtectionLevel.Encrypted => Colors.LightGreen,
				_ => null,
			};
		}
	}
