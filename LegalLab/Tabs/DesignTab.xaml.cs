...
namespace LegalLab.Tabs
{
	...
	public partial class DesignTab : UserControl
	{
		...
		public DesignTab()
		{
			...
			byte[] Bin = Waher.Runtime.IO.Resources.LoadResource(typeof(DesignModel).Namespace + ".AvalonExtensions.SmartContractMarkdown.xshd", typeof(App).Assembly);
			...
			HighlightingManager.Instance.RegisterHighlighting(Def.Name, [], Def);
