...
namespace LegalLab.Models.Legal.Items.Parameters
{
	...
	/// </summary>
	public class DateTimeParameterInfo : RangedParameterInfo
	{
		...
		public DateTimeParameterInfo(Contract Contract, DateTimeParameter Parameter, Control Control, Control MinControl, Control MinIncludedControl,
		...
		private static DateTime? Parse(string Value)
		{
			if (string.IsNullOrEmpty(Value))
				return null;
			else if (XML.TryParse(Value, out DateTime d))
				return d;
			else
